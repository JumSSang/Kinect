...
void CSkinnedMesh::SetKinectMatrix(unsigned int index, const D3DXMATRIX &Matrix)
{
	...
	if (m_filename == "ironman2.X")
	{
		...
		static const char *strBoneName[] = {
			...
			"Bip01_L_Ankle",
			"NULL"
			/*"Bip_Pelvis", "Bip_Spine", "Bip_Neck", "Bip_Head", "Bip_R_UpperArm", "Bip_R_ForeArm", "Bip_R_Wrist", NULL,
	...
	LPD3DXMESHCONTAINER *ppNewMeshContainer)
{
	...
	*ppNewMeshContainer = NULL;
	...
	else // if no materials provided, use a default one
	{
		...
		pMeshContainer->pMaterials[0].MatD3D.Diffuse.a = 0.2f;
